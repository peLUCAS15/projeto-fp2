...
void carregarPalavrasIniciais(Palavra **lista, int *total){
  ...
    // Fase 1 - RESIDENT EVIL 
   
    adicionarPalavraDireta(lista, total, "Zumbi", "Criatura infectada por vírus", 1, "Resident Evil");
    adicionarPalavraDireta(lista, total, "Vírus", "Causa da infecção no jogo", 1, "Resident Evil");
...
    adicionarPalavraDireta(lista, total, "Munição", "Essencial para sobreviver", 2, "Resident Evil");
...
    adicionarPalavraDireta(lista, total, "Destruição", "Poder dos deuses Hakaishin", 3, "Dragon Ball");
...
    adicionarPalavraDireta(lista, total, "Logia", "Tipo de Akuma no Mi elementar", 3, "One Piece"); // Ajuste: Lugia é Pokémon
...
    adicionarPalavraDireta(lista, total, "Chapéu", "Símbolo do protagonista Luffy", 1, "One Piece");
...
    adicionarPalavraDireta(lista, total, "Luffy", "Protagonista que estica", 1, "One Piece"); // Nova
    adicionarPalavraDireta(lista, total, "Sanji", "Cozinheiro da tripulação", 1, "One Piece"); // Nova
    adicionarPalavraDireta(lista, total, "Tesouro", "O grande 'One Piece' é um...", 2, "One Piece"); // Nova

    // Fase 5 - SILENT HILL (Ajustada e Completa - 20/20)
 
    adicionarPalavraDireta(lista, total, "Nevoa", "Marca registrada da cidade", 1, "Silent Hill");
    adicionarPalavraDireta(lista, total, "Rádio", "Emite ruídos quando há monstros", 1, "Silent Hill");
...
    adicionarPalavraDireta(lista, total, "Lisa", "Enfermeira que aparece no primeiro jogo", 2, "Silent Hill"); // Ajuste: "Tina" é muito secundária
    adicionarPalavraDireta(lista, total, "Harry", "Protagonista do primeiro jogo", 1, "Silent Hill"); // Ajuste: "Mason" é o sobrenome
...
    adicionarPalavraDireta(lista, total, "Pyramid", "Monstro com máscara triangular", 3, "Silent Hill"); // Ajuste: Nome encurtado para o jogo
...
    adicionarPalavraDireta(lista, total, "Lírio", "Flor símbolo da cidade", 1, "Silent Hill");
